...
def run_tuning(
    ...
    Args:
        ...
        multivariate_tpe: Whether to use multivariate TPE, e.g. when parameters interact and
            there are enough trials. Can only be used with TPESampler.
    ...
    if tuning_pruning_percentile is None:
        ...
        tuning_pruner = optuna.pruners.PercentilePruner(
            ...
            n_startup_trials=2,  # do at least two full reference runs before pruning
